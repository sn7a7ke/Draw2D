...
namespace Plane2D.Tests
{
    ...
    class Point2DTest
    {
        ...
        [Test]
        public void RotateAroundThePoint() => Assert.IsTrue(p1.RotateAroundThePoint(Math.PI / 2, p2).Equals(new Point2D(8, 5)));

        [Test]
        public void RotateAroundThePoint_AngleIsZero() => Assert.IsTrue(p1.RotateAroundThePoint(0, p2).Equals(p1));
        ...
        {
            Point2D p3 = new Point2D(1, 15);
            Assert.IsTrue(Point2D.Min(p3, p2, p1).Equals(new Point2D(1, 3)));
        }
        ...
        {
            object obj = null;
            Assert.IsFalse(p1.Equals(obj));
        }

        [Test]
        public void Equals_NullPoint_False()
        {
            Point2D p2 = null;
        ...
        [Test]
        public void Equals_False() => Assert.IsFalse(p1.Equals(p2));
